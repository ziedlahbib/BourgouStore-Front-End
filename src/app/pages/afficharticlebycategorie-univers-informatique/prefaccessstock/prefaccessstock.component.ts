...
@Component({
  selector: 'app-prefaccessstock',
  templateUrl: './prefaccessstock.component.html',
  styleUrls: ['./prefaccessstock.component.scss']
})
export class PrefaccessstockComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.articleservice.affichArticlebycategorieUniversInformatiqueperfetaccesstock().subscribe(
      data=>{
        console.log(data);
