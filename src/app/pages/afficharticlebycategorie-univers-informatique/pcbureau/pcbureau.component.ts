...
@Component({
  selector: 'app-pcbureau',
  templateUrl: './pcbureau.component.html',
  styleUrls: ['./pcbureau.component.scss']
})
export class PcbureauComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.articleservice.affichArticlebycategorieUniversInformatiquepcbureau().subscribe(
      data=>{
        console.log(data);
